...
// BMAD Types (Business Model & Architecture Documentation)
...
// Documentation and Hooks types moved to their respective files

// Service Integration Types
// Import types from other modules instead of using them directly
export interface ServiceConfig {
  ...
  hooks: {
    enabled: boolean;
    fileWatch: any; // Use 'any' to avoid circular dependency
    notifications: any; // Use 'any' to avoid circular dependency
...
// Removed duplicated types - these are now in documentation.types.ts and hooks.types.ts
