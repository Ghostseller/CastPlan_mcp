...
export class DocumentTreeService {
    ...
    async addToTree(documentId, parentId) {
        try {
    ...
    async moveInTree(nodeId, newParentId) {
        try {
    ...
    async getSubtree(rootId, maxDepth = 10) {
        try {
            const nodes = [];
    ...
    async createTreeNode(nodeData) {
        const node = {
            ...
            treeType: nodeData.treeType || 'component'
        };
        await this.db.run(`
    ...
    async updateParentChildren(parentId, childId) {
        try {
...
//# sourceMappingURL=DocumentTreeService.js.map