...
export class StandardMCPConfigGenerator {
     ...
     */
    generateStandardMCPConfig(envConfig, options = {}) {
     ...
     */
    generateConfigFiles(envConfig, options = {}) {
     ...
     */
    async installConfigFile(configFile, options = {}) {
        ...
        // Write configuration
        await fs.writeFile(configFile.path, JSON.stringify(finalConfig, null, 2), 'utf8');
...
//# sourceMappingURL=StandardMCPConfigGenerator.js.map